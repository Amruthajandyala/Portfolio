...
function App() {
  ...
  const skills = [
    { name: 'HTML', percentage: 90, color: '#E34F26', icon: '🌐' },
    { name: 'CSS', percentage: 90, color: '#1572B6', icon: '🎨' },
  ...
  const projects = [
    {
      ...
      description: 'A fully functional real-time multi-page college website using HTML and CSS. This website serves information about the college, courses, events, and announcements.',
      image: 'https://images.pexels.com/photos/256490/pexels-photo-256490.jpeg?auto=compress&cs=tinysrgb&w=400',
      link: 'https://github.com/Amruthajandyala/College-Website-Model',
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="flex-1 text-center lg:text-left order-2 lg:order-1">
              ...
              <div className="flex justify-center lg:justify-start gap-4 mb-8">
                {['facebook', 'instagram', 'twitter', 'linkedin'].map((social) => (
                  <a
                    key={social}
                    href="#"
                    className="w-12 h-12 border-2 border-cyan-400 rounded-full flex items-center justify-center text-cyan-400 hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-400/50"
                  >
              ...
              <a
                href="https://drive.google.com/file/d/1Yym8vJkTTBTmjq_t0XlA1x34Ik_I7QgM/view"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <h3 className="text-2xl md:text-3xl text-cyan-400 font-semibold mb-6">Frontend Developer</h3>
              <p className="text-lg leading-relaxed mb-8 text-gray-300">
                Enthusiastic and detail-oriented aspiring front-end developer with a strong foundation in HTML, CSS, 
                JavaScript, and responsive design. Eager to apply my skills and learn from industry professionals in a 
                dynamic internship role. Passionate about creating user-friendly, visually appealing web interfaces and 
                committed to contributing to innovative projects while gaining hands-on experience in front-end development.
              </p>
              <a
                href="#contact"
                className="inline-flex items-center gap-2 bg-cyan-400 hover:bg-cyan-500 text-slate-900 font-bold py-3 px-6 rounded-full transition-all duration-300 hover:shadow-lg hover:shadow-cyan-400/50"
